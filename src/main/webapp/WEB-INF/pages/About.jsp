    ...
    <div class="container" id="about">
        ...
        <div class="row" style="margin-top: 50px;">
            ...
            <div class="col-md-7 py-3 py-md-0">
                <p>ABP Electronics is an Indian e-commerce company. ABP Electronics was founded in October 2020 by Anandraj, Bala Vignesh and Prasanna Venkatesh, alumni of the Madurai, Tamilnadu. ABP Electronics platform that sells many product lines, include HomeAppliances, SmartPhones, Smartwatch etc. </p>
            </div>
        </div>
    </div>
